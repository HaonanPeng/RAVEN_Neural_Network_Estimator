...
%object settings-----------------------------------------------------------
num_ref = [3,4,5,6,7,8]; %number of reference objects
P_obj = [127,-127,279.4;              % obj1 (reference) mark0_high
         ...
         -110 29.3 244.475;             % obj9 ball0
         -70 29.3 284.475;             % obj10 ball1
...
for i = 1:num_cam
    ...
    error_ball_sum = error_ball_sum+abs(sum(ERROR_now(1:3,9:11)));
end
error_ball_sum
