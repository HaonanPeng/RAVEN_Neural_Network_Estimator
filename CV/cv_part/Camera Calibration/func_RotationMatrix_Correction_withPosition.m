function [RotationMatrix_now,P_cam_now,ERROR_pre,ERROR_now] = func_RotationMatrix_Correction_withPosition(R_cam2chess,R_chess,P_cam,Image_object_center,P_object,resolution,ps,f,num_ref)
...
function eqn = findRotation(x) 
    ...
    for i = 1:num_obj
        V_cam2obj(i,:) =  (P_object(i,:)-[x(4),x(5),x(6)]);
...
position_difference = x(4:6)-P_cam 
P_cam_now = x(4:6);
